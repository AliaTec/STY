...
Public Class PolizaSuntory
    ...
    Public Sub PolizaSuntory_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        ...
        Me.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" & _
                sConnection, "spq_PolizaContableSuntoryTotales @IdRazonSocial = " + Me.Parameters("IdRazonSocial").Value + "," & _
        ...
        Dim SubReportePercepciones As New PolizaSuntoryTotal
