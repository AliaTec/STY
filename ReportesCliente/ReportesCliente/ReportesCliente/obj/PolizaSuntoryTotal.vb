...
Public Class PolizaSuntoryTotal
    ...
    Private Sub PolizaSuntoryTotal_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        ...
        sConnection, "spq_PolizaContableSuntory @IdRazonSocial = " + Me.Parameters("IdRazonSocial").Value + "," & _
