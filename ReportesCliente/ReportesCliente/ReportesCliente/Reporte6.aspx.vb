...
Partial Public Class Reporte6
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        RPT.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" + sConnection, "sp_Reporte_ISNSuntory @IdRazonSocial = <%IdRazonSocial%>" & _
               "@Anio = <%Anio%>,@Mes = <%Mes%>,@IdElementoUsuario = <%IdElementoUsuario%>,@UID = <%UID%>, @LID = <%LID%>, @idAccion = <%idAccion%>", 90)
